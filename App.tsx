...
const PrivacyPage = lazy(() => import("./components/LegalPages").then(module => ({ default: module.PrivacyPage })));
...
const AppContent = () => {
  ...
  const renderContent = () => {
    ...
    return (
      <Suspense fallback={<div className="flex justify-center items-center h-64"><Spinner size="12" /></div>}>
        {(() => {
          switch (view) {
            case "LANDING":
              return (
