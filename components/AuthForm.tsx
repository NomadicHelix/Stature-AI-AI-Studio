  ...
  return (
    <div className="w-full max-w-md mx-auto py-20">
      <div className="bg-brand-gray/30 p-8 rounded-2xl border border-gray-700 shadow-2xl">
        ...
        {error && (
          <p className="bg-red-900/20 text-red-400 p-3 rounded-lg mb-6 text-center text-sm">
            {error}
          </p>
        )}
        ...
        <form onSubmit={handleEmailPasswordAuth} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-3 bg-brand-primary text-brand-dark font-bold rounded-lg hover:bg-brand-secondary transition-colors disabled:opacity-50 flex justify-center items-center"
            disabled={isLoading}
          >
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-brand-gray/30 text-gray-400">OR</span>
          </div>
        </div>

        <button
          onClick={handleGoogleAuth}
          className="w-full py-3 bg-white text-black font-semibold rounded-lg flex items-center justify-center gap-2 hover:bg-gray-200 transition-colors disabled:opacity-50"
          disabled={isLoading}
        >
