export const PrivacyPage = () => (
  <div className="container mx-auto px-6 py-12 text-gray-300 max-w-4xl">
    ...
    <div className="prose prose-invert max-w-none">
      <p>
        Your privacy is important to us. It is Stature-AI's policy to respect
...
export const TermsPage = () => (
  <div className="container mx-auto px-6 py-12 text-gray-300 max-w-4xl">
    ...
    <div className="prose prose-invert max-w-none">
      <h2>1. Terms</h2>
      <p>
        By accessing the website at Stature-AI, you are agreeing to be bound by
      ...
      <ol type="a">
        <li>
          ...
          materials (information or software) on Stature-AI's website for
        ...
        <li>
          ...
          restrictions and may be terminated by Stature-AI at any time. Upon
      ...
      <h2>3. Disclaimer</h2>
      <p>
        The materials on Stature-AI's website are provided on an 'as is' basis.
        Stature-AI makes no warranties, expressed or implied, and hereby
      ...
      <h2>4. Limitations</h2>
      <p>
        In no event shall Stature-AI or its suppliers be liable for any damages
        (including, without limitation, damages for loss of data or profit, or
        due to business interruption) arising out of the use or inability to use
        the materials on Stature-AI's website, even if Stature-AI or a
        Stature-AI authorized representative has been notified orally or in
        writing of the possibility of such damage.
      </p>

      <h2>5. Accuracy of materials</h2>
      <p>
        The materials appearing on Stature-AI's website could include technical,
        typographical, or photographic errors. Stature-AI does not warrant that
        any of the materials on its website are accurate, complete or current.
        Stature-AI may make changes to the materials contained on its website at
        any time without notice. However Stature-AI does not make any commitment
        to update the materials.
      </p>

      <h2>6. Links</h2>
      <p>
        Stature-AI has not reviewed all of the sites linked to its website and
        is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement by Stature-AI of the
        site. Use of any such linked website is at the user's own risk.
      </p>

      <h2>7. Modifications</h2>
      <p>
        Stature-AI may revise these terms of service for its website at any time
