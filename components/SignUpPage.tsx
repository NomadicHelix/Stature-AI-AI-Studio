      ...
      <div className="w-full max-w-md p-8 space-y-8 bg-brand-gray/50 rounded-2xl shadow-2xl border border-brand-primary/20">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-400">
            Join Stature<span className="text-brand-primary">AI</span> and start generating your professional headshots today.
          </p>
        </div>
        ...
        <div className="mt-6">
            ...
            <div className="mt-6">
                <button onClick={signInWithGoogle} className="w-full flex justify-center items-center py-2 px-4 border border-gray-600 rounded-md shadow-sm bg-gray-700 text-sm font-medium text-white hover:bg-gray-600">
