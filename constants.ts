...
export const STYLES: HeadshotStyle[] = [
  {
    ...
    name: "Corporate",
    description:
      "Clean, professional, and confident. Perfect for LinkedIn and company websites.",
    imageUrl:
      "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    prompt: `
  ...
  },
  {
    ...
    name: "Creative",
    description:
      "Expressive and artistic. Ideal for artists, designers, and innovators.",
    imageUrl:
      "https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?q=80&w=800&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    prompt: `
  ...
  },
  {
    ...
    name: "Casual",
    description:
      "Friendly and approachable. Great for social media and personal branding.",
    imageUrl:
  ...
  },
  {
    ...
    name: "Dramatic",
    description:
      "Bold and impactful. For actors, public speakers, and thought leaders.",
    imageUrl:
